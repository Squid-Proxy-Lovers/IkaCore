...
class Finding:
    ...
    discovered_by: Optional[str] = None  # agent name
...
class NetworkSummary:
    ...
    targets: Dict[str, Target]  # ip -> Target
    network_diagram: str = ""  # Text/mermaid diagram
...
class BaseSystem:
    ...
    def from_model_and_tools(
        ...
        *,
        ...
        prompt_text = system_prompt or description or f"You are a {role} agent."
        agent = IkaBaseAgent(
            name=name,
